...
export const hindiTranslations = {
  ...
  // Add these keys
  home: 'होम',
  welcomeToGrapeGuard: 'ग्रेपगार्ड में आपका स्वागत है',
  connectedToSensors: 'सेंसर से जुड़ा हुआ',
  lastUpdated: 'अंतिम अपडेट',
  diseaseRiskStatus: 'रोग जोखिम स्थिति',
  low: 'कम',
  ...
  grapeDiseasesTitle: 'अंगूर के रोग',
  knowSymptomsAndTips: 'लक्षण और पहचान की जानकारी',
  viewGrapeDiseases: 'अंगूर के रोग देखें',
  dashboard: 'डैशबोर्ड',
  location: 'स्थान',
  refresh: 'रीफ्रेश',
  // Hindi translation file
  loadingGrapeGuard: 'ग्रेपगार्ड लोड हो रहा है...',
  celsius: 'सी',
  currentEnvironmentalConditionsFavorable: 'वर्तमान पर्यावरणीय स्थितियां अनुकूल हैं। पश्चिमी महाराष्ट्र की अंगूर किस्मों के लिए कोई तत्काल रोग जोखिम नहीं मिला।',
  borerInfestationBokadlela: 'बोकडलेल (बोरर संक्रमण)',
  powderyMildewBhuri: 'भुरी (पाउडरी मिल्ड्यू)',
  yellowOilyPatches: 'पत्तियों के ऊपरी भाग पर पीले तेलीय धब्बे',
  whiteCottonLayer: 'पत्तियों के नीचे सफेद कपास जैसी परत',
  darkSpotsLightCenters: 'पत्तियों और फलों पर हल्के केंद्र वाले काले धब्बे',
  cracksOnStems: 'तनों या अंगूरों पर दरारें',
  smallHolesInStems: 'तनों या अंगूरों में छोटे छेद',
  dustLikePowder: 'छेदों के पास धूल जैसा पाउडर',
  whitePowderOnLeaves: 'पत्तियों और अंगूरों पर सफेद पाउडर',
  twistedCurledLeaves: 'पत्तियां मुड़ी हुई या घुमावदार दिखती हैं',
  davnyaDescription: 'दवन्या (डाउनी मिल्ड्यू) एक आम फंगल रोग है जो नम स्थितियों में पनपता है।',
  karpaDescription: 'करपा (एंथ्रेक्नोज), जिसे बर्ड्स आई रॉट भी कहते हैं, काले धंसे हुए धब्बे बनाता है।',
  bokadlelaDescription: 'बोकडलेल (बोरर संक्रमण) कीट लार्वा के कारण होता है जो तनों में छेद करते हैं।',
  bhuriDescription: 'भुरी (पाउडरी मिल्ड्यू) एक फंगल संक्रमण है जिसमें सफेद पाउडरी कोटिंग होती है।',
  ...
  espCam: "ESP32-कैमरा",
  realDetectron: "रीयल डिटेक्ट्रॉन2",
  source: "स्रोत",
  image: "छवि",
  ...
  // Disease Names
  karpaAnthracnose: "करपा (एंथ्रैक्नोस)",
  bhuriPowderyMildew: "भुरी (पाउडरी मिल्ड्यू)",
  bokadlelaBorer: "बोकडलेला (बोरर संक्रमण)",
