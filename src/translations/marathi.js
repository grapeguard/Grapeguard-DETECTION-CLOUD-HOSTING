...
export const marathiTranslations = {
  ...
  // Add these keys
  home: 'होम',
  welcomeToGrapeGuard: 'ग्रेपगार्डमध्ये आपले स्वागत',
  connectedToSensors: 'सेन्सरशी जोडले आहे',
  lastUpdated: 'शेवटचे अपडेट',
  diseaseRiskStatus: 'रोग धोका स्थिती',
  low: 'कमी',
  ...
  grapeDiseasesTitle: 'द्राक्ष रोग',
  knowSymptomsAndTips: 'लक्षणे आणि ओळख टिप्स',
  viewGrapeDiseases: 'द्राक्ष रोग पहा',
  dashboard: 'डॅशबोर्ड',
  location: 'स्थान',
  refresh: 'रिफ्रेश',
  // Marathi translation file
  loadingGrapeGuard: 'ग्रेपगार्ड लोड होत आहे...',
  celsius: 'सी',
  currentEnvironmentalConditionsFavorable: 'सध्याची पर्यावरणीय परिस्थिती अनुकूल आहे। पश्चिम महाराष्ट्रातील द्राक्ष जातींसाठी कोणताही तात्काळ रोगाचा धोका आढळला नाही।',
  grapeDiseasesbyStage: 'वाढीच्या टप्प्यानुसार द्राक्ष रोग',
  seedlingStage: 'रोप टप्पा',
  vegetativeStage: 'वनस्पति टप्पा',
  floweringStage: 'फुलांचा टप्पा',
  maturityStage: 'पिकवण्याचा टप्पा',
  symptoms: 'लक्षणे',
  davnya: 'दवन्या',
  karpa: 'करपा',
  bokadlela: 'बोकडलेला',
  bhuri: 'भुरी',
  downyMildewDavnya: 'दवन्या (डाउनी मिल्ड्यू)',
  anthracnoseKarpa: 'करपा (अँथ्रॅक्नोज)',
  borerInfestationBokadlela: 'बोकडलेला (बोरर संसर्ग)',
  powderyMildewBhuri: 'भुरी (पावडरी मिल्ड्यू)',
  yellowOilyPatches: 'पानांच्या वरच्या भागावर पिवळे तेलकट डाग',
  whiteCottonLayer: 'पानांच्या खाली पांढरा कापसासारखा थर',
  darkSpotsLightCenters: 'पाने आणि फळांवर हलके केंद्र असलेले काळे डाग',
  cracksOnStems: 'खोडावर किंवा द्राक्षांवर तडे',
  smallHolesInStems: 'खोडामध्ये किंवा द्राक्षांमध्ये लहान छिद्रे',
  dustLikePowder: 'छिद्रांजवळ धूळसारखी पावडर',
  whitePowderOnLeaves: 'पाने आणि द्राक्षांवर पांढरी पावडर',
  twistedCurledLeaves: 'पाने वळलेली किंवा कुरळी दिसतात',
  davnyaDescription: 'डाउनी मिल्ड्यू (दवन्या) हा एक सामान्य बुरशीजन्य रोग आहे जो ओलसर परिस्थितीत वाढतो।',
  karpaDescription: 'अँथ्रॅक्नोज (करपा), ज्याला बर्ड्स आय रॉट देखील म्हणतात, काळे खोल डाग निर्माण करतो।',
  bokadlelaDescription: 'बोरर संसर्ग (बोकडलेला) कीटक अळींमुळे होतो जे खोडामध्ये छिद्रे करतात।',
  bhuriDescription: 'पावडरी मिल्ड्यू (भुरी) हा बुरशीजन्य संसर्ग आहे ज्यामध्ये पांढरी पावडरची थर असते।',
  alertSummary: 'सूचना सारांश',
  critical: 'गंभीर',
  warning: 'चेतावणी',
  info: 'माहिती',
  ...
  waitingForAIDetection: "AI शोधाची प्रतीक्षा करत आहे",
  ...
  disease: "रोग",
  severity: "तीव्रता",
  realDetectron: "रिअल डिटेक्ट्रॉन2",
  source: "स्रोत",
  image: "प्रतिमा",
  downloadAnalysis: "विश्लेषण डाउनलोड करा",
  
  // Disease Names
  karpaAnthracnose: "करपा (अँथ्रकनोज)",
  bhuriPowderyMildew: "भुरी (पावडरी मिल्ड्यू)",
  bokadlelaBorer: "बोकडलेला (बोरर संसर्ग)",
  davnyaDownyMildew: "दवन्या (डाउनी मिल्ड्यू)",
  healthy: "निरोगी",
