...
export const englishTranslations = {
  ...
  diseaseRiskStatus: 'Disease Risk Status',
  low: 'Low',
  ...
  grapeDiseasesTitle: 'Grape Diseases',
  knowSymptomsAndTips: 'Know symptoms and identification tips',
  viewGrapeDiseases: 'View Grape Diseases',
  dashboard: 'Dashboard',
  location: 'Location',
  refresh: 'REFRESH',
  // English translation file
  loadingGrapeGuard: 'Loading GrapeGuard...',
  celsius: 'C',
  currentEnvironmentalConditionsFavorable: 'Current environmental conditions are favorable. No immediate disease risks detected for Western Maharashtra grape varieties.',
  grapeDiseasesbyStage: 'Grape Diseases by Stage',
  ...
  bokadlela: 'Bokadlela',
  bhuri: 'Bhuri',
  downyMildewDavnya: 'Downy Mildew (Davnya)',
  anthracnoseKarpa: 'Anthracnose (Karpa)',
  borerInfestationBokadlela: 'Borer Infestation (Bokadlela)',
  powderyMildewBhuri: 'Powdery Mildew (Bhuri)',
  yellowOilyPatches: 'Yellow oily patches on the top of leaves',
  whiteCottonLayer: 'White cotton-like layer under the leaves',
  darkSpotsLightCenters: 'Dark spots with light centers on leaves and fruits',
  cracksOnStems: 'Cracks on stems or grapes',
  smallHolesInStems: 'Small holes in stems or grapes',
  dustLikePowder: 'Dust-like powder near the holes',
  whitePowderOnLeaves: 'White powder seen on leaves and grapes',
  twistedCurledLeaves: 'Leaves look twisted or curled',
  davnyaDescription: 'Downy Mildew (Davnya) is a common fungal disease that thrives in humid conditions.',
  karpaDescription: 'Anthracnose (Karpa), also known as bird\'s eye rot, causes dark, sunken spots.',
  bokadlelaDescription: 'Borer Infestation (Bokadlela) is caused by insect larvae that bore into stems.',
  bhuriDescription: 'Powdery Mildew (Bhuri) is a fungal infection marked by white powdery coating.',
